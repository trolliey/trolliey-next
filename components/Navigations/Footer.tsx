      ...
      <div className=" border-b-none border-gray-200 md:border-b">
        <div className="mx-auto hidden w-full max-w-7xl grid-cols-1 items-center gap-4 py-4 md:grid md:grid-cols-2 md:py-4 lg:grid-cols-4 ">
          {data.benefits.map((benefit, index) => (
            <div
              key={index}
              className="col-span-1 mx-auto flex cursor-pointer flex-col items-center border-b border-gray-200 pb-4 text-blue-primary hover:text-new-primary md:flex-row md:border-none md:pb-0"
            >
