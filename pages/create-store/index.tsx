...
import { Select, Divider, Spinner } from '@chakra-ui/react'
                ...
                <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                  <div>
                    <div>
                      ...
                      <p className="mt-1 max-w-2xl text-sm text-gray-500">
                        This information will be used by us to know more about
        ...
        <div className="max-w-7xl py-8">
          <div className="mx-auto rounded bg-white p-4 md:p-8">
            ...
            <div className="flex w-full flex-row items-center justify-between">
              ...
              <button
                className="flex items-center justify-center rounded-xl bg-blue-primary px-5 py-2 text-white"
                type="submit"
              >
                {loading ? <Spinner /> : 'Apply For Store'}
              </button>
            </div>
          </div>
        </div>
