...
function login() {
    ...
    return (
        <GeneralLayout og_url='login' no_text title='Login to your Trolliey account' description='Welcome back to Trolliey, login and enjoy shopping'>
                        ...
                        <div className="space-y-6" >
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="text-sm">
                                    <a href="/forgot-password" className="font-medium text-blue-primary hover:text-red-400">
