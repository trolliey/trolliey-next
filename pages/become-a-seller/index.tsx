            ...
            <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                <p className="mx-auto mt-6 max-w-lg text-center text-xl text-indigo-200 sm:max-w-3xl">
                  ...
                  internationally by providing you with the necessary tools for
                  online selling.
                </p>
                  ...
                  <div className="mx-auto max-w-lg overflow-hidden rounded-lg shadow-lg lg:flex lg:max-w-none">
                    <div className="flex-1 bg-white px-6 py-8 lg:p-12">
                      ...
                      <p className="mt-6 text-base text-gray-500">
                        You pay a subscription Fee of $10 per seller account per
                        month and you can un subscribe or cancel at any time you
                        want
                      </p>
                      <div className="mt-8">
                ...
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-4 text-lg text-gray-500">
                      More than half of the products sold in our stores are from
                      independent sellers. We made online shopping easier, apply
                      to sell and access tools you need to increase sales and
                      grow your business.
                    </p>
                    <div className="mt-6">
                      <div className="mt-6">
              ...
              <div className="mx-auto max-w-xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-4 text-lg text-gray-500">
                      Get access to over a thousand and still growing customers
                      on trolliey. Manage your stock the way you want, Safe and
